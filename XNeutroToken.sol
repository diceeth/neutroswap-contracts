...
// File: src/tokens/interfaces/IXNeutroTokenUsage.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.7/contracts/utils/ReentrancyGuard.sol
...
// File: src/tokens/interfaces/tokens/IXNeutroToken.sol
...
// File: src/tokens/interfaces/tokens/INeutroTokenV2.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.7/contracts/token/ERC20/ERC20.sol
...
// File: src/tokens/XNeutroToken.sol
...
/*
 * xNEUTRO is Neutroswap's escrowed governance token obtainable by converting NEUTRO to it
...
contract XNeutroToken is Ownable, ReentrancyGuard, ERC20("Neutro escrowed token", "xNEUTRO"), IXNeutroToken {
  ...
  INeutroTokenV2 public immutable neutroToken; // NEUTRO token to convert to/from
  IXNeutroTokenUsage public dividendsAddress; // Neutroswap dividends contract
  ...
  constructor(INeutroTokenV2 neutroToken_) {
   ...
   * Must only be called by owner
   */
  function updateDividendsAddress(IXNeutroTokenUsage dividendsAddress_) external onlyOwner {
